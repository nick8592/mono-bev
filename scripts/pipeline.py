...
This script runs end-to-end inference on the nuScenes dataset using the trained model.
"""
...
from src.data.data_loader import NuScenesDataset
from nuscenes.nuscenes import NuScenes
from src.models.detector import YOLODetector
from src.models.bev_transform import BEVTransformModel, prepare_batch_for_bev_model
