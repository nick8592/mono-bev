...
This script trains the BEV transformation model using the nuScenes dataset.
It includes gradient accumulation, early stopping, checkpointing, and logging.
"""
...
from src.models.bev_transform import (
    BEVTransformModel, 
    BEVTransformLoss, 
...
class BEVTrainer:
    ...
    def train_epoch(self, train_loader: DataLoader, epoch: int) -> float:
        ...
        for batch_idx, batch in enumerate(pbar):
            ...
            # Convert images from tensor to numpy for YOLO
            images_np = []
