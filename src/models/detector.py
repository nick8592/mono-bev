...
This module provides a wrapper around YOLOv11 for object detection,
with specific mapping between COCO classes and nuScenes classes.
"""
...
class YOLODetector:
    ...
    Attributes:
        ...
        class_mapping: Mapping from nuScenes to COCO classes
        coco_to_nuscenes: Reverse mapping from COCO to nuScenes
    """
    ...
    def _get_nuscenes_class_id(self, class_name: str) -> int:
        ...
        Returns:
            Integer class ID, or -1 if unknown
        """
        class_mapping = {
            'car': 0,
            'truck': 1,
